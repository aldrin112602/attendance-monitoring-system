                    ...
                    <tbody>
                        @foreach ($faculty as $faculty)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap dark:text-white">{{ $faculty->created_at }}</td>
                                <td class="px-6 py-4 whitespace-no-wrap dark:text-white">{{ $faculty->updated_at }}</td>
                                <td class="px-6 py-4 whitespace-no-wrap dark:text-white">{{ $faculty->status }}</td>
