                    ...
                    <tbody>
                        @foreach ($admins as $admin)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap dark:text-white">{{ $admin->created_at }}</td>
                                <td class="px-6 py-4 whitespace-no-wrap dark:text-white">{{ $admin->updated_at }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap dark:text-white">
                                    <a href="#" class="text-indigo-600 hover:text-indigo-900 px-3 rounded-xl py-2 bg-indigo-200">Edit</a>
                                    <a href="#" class="text-emerald-600 hover:text-emerald-900 px-3 rounded-xl py-2 bg-emerald-200">Preview</a>
                                    <a href="#" class="text-rose-600 hover:text-rose-900 px-3 rounded-xl py-2 bg-rose-200">Delete</a>
